			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form method="post" action="${pageContext.request.contextPath}/satellite/listExample" class="row g-3" >
							
							
								<div class="col-md-6">
									<label for="denominazione" class="form-label">Denominazione </label>
									<input type="text" name="denominazione" id="denominazione" class="form-control" placeholder="Inserire il denominazione"  >
								</div>
								...
								<div class="col-md-3">
								    ...
								    <select class="form-select" id="statoSatellite" name="statoSatellite" >
