			  		...
			  		<div class='card'>
					    ...
					    <div class='card-body'>
					    	...
					    	<dl class="row">
							  ...
							  <dd class="col-sm-9">${show_satellite_attr.statoSatellite}</dd>
					    	</dl>
					    ...
					    <div class='card-footer'>
					        <a href="${pageContext.request.contextPath}/satellite/list" class='btn btn-outline-secondary' style='width:80px'>
