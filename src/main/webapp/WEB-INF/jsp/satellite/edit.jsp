			...
			<div class='card'>
				...
				<div class='card-body'>
					...
					<form:form modelAttribute="edit_satellite_attr" method="post"
						action="${pageContext.request.contextPath}/satellite/update"
						...
						<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDate" type='date'
							value='${edit_satellite_attr.dataLancio}' />
						<div class="col-md-3">
							<label for="dataLancio" class="form-label">Data di Lancio
						...
						<fmt:formatDate pattern='yyyy-MM-dd' var="parsedDate" type='date'
							value='${edit_satellite_attr.dataRientro}' />
						<div class="col-md-3">
							...
							<spring:bind path="statoSatellite">
								<select class="form-select ${status.error ? 'is-invalid' : ''}"
									...
									<option value="IN_MOVIMENTO"
										${edit_satellite_attr.statoSatellite == 'IN_MOVIMENTO'?'selected':''}>IN_MOVIMENTO</option>
									<option value="FISSO"
										${edit_satellite_attr.statoSatellite == 'FISSO'?'selected':''}>FISSO</option>
									<option value="DISATTIVATO"
										${edit_satellite_attr.statoSatellite == 'DISATTIVATO'?'selected':''}>DISATTIVATO</option>
								</select>
							</spring:bind>
