	...
	<main class="flex-shrink-0">
		<div class="container">
			...
			<div class='card'>
				...
				<form:form method="post" action="${pageContext.request.contextPath}/satellite/remove" class="row g-3"
					...
					<div class='card-body'>
						...
						<dl class="row">
							...
							<dd class="col-sm-9">
								<fmt:formatDate type="date"
									value="${delete_satellite_attr.dataLancio}" />
							</dd>
						</dl>
						...
						<dl class="row">
							...
							<dd class="col-sm-9">
								<fmt:formatDate type="date"
									value="${delete_satellite_attr.dataRientro}" />
							</dd>
						</dl>

						<dl class="row">
							<dt class="col-sm-3 text-right">Stato :</dt>
							<dd class="col-sm-9">${delete_satellite_attr.statoSatellite}</dd>
						</dl>
					...
					<div class='card-footer'>
						<a href="${pageContext.request.contextPath}/satellite/list"
							class='btn btn-outline-secondary' style='width: 80px'> <i
							class='fa fa-chevron-left'></i> Back
						</a> <input type="submit" class='btn btn-outline-danger'
							value="Conferma">
					</div>
				</form:form>
				<!-- end card -->
